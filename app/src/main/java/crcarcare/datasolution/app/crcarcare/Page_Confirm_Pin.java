...
public class Page_Confirm_Pin extends MainActivity {
    String digi1 = null;
    String digi2 = null;
    String digi3 = null;
    String digi4 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_confirm_pin_screen);
    ...
    private void getPreference(){
        String Pin = "";
        String CPin = digi1+digi2+digi3+digi4;

        if (mPre.contains("pref_Spin")){
            Pin = mPre.getString("pref_Spin","");
        }
        if(Pin.equals(CPin))
        {
            SharedPreferences.Editor editor = mPre.edit();
            editor.putString("pref_pin",digi1+digi2+digi3+digi4);
            editor.apply();
            Intent i = new Intent(Page_Confirm_Pin.this,Page_Menu.class);
            startActivity(i);
            finish();
        }
        else
        {
            Toast.makeText(this, "รหัสไม่ตรงกัน",Toast.LENGTH_SHORT).show();
            Intent i = new Intent(Page_Confirm_Pin.this,Page_SetPin.class);
            startActivity(i);
            finish();
        }
    }
